...
#include "pointcloud_tools_ros/file_to_message.h"
#include "pointcloud_tools_ros/message_to_file.h"
...
private:
    bool load(pointcloud_tools_ros::file_to_message::Request& request,
            pointcloud_tools_ros::file_to_message::Response& response);

    bool save(pointcloud_tools_ros::message_to_file::Request& request,
